...
func fetchImage(ctx context.Context, rawURL, mode string) (data []byte, mime string, err error) {
	...
	data, mime = optimizeImage(data, mime, mode) // shrink before it hits context
